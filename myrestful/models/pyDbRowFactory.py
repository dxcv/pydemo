# -*- coding: utf-8 -*-
# @Time    : 2018/12/19 16:10
# @Author  : dodo8619
# @Email   : lj16888619@gmail.com
# @File    : pyDbRowFactory.py.py
...
class DbRowFactory(object):
    ...
    def _getAllMembers(self, clazz):
        ...
        sysMemberList = ['__class__', '__doc__', '__init__', '__new__', '__subclasshook__', '__dict__', '__module__',
                         '__delattr__', '__getattribute__', '__hash__', '__repr__', '__setattr__', '__str__',
                         '__format__', '__reduce__', '__reduce_ex__', '__sizeof__', '__weakref__']
